...
oapi_config.OPENAPI_YAML = path.join(
  oapi_config.ROOT_DIR,
  "api",
  "openapi.yaml"
);
  ...
  clients: [
    {
      ...
      redirect_uris: [
        ...
        "https://app.5gsvc:9000/callback.html",
        "https://app.5gsvc/callback.html",
        "https://oidcdebugger.com/debug",
      ],
      post_logout_redirect_uris: [
        "http://localhost:9000/index.html",
        "http://app.5gsvc:9000/index.html",
        "https://app.5gsvc:9000/index.html",
        "https://app.5gsvc/index.html",
      ],
      response_types: ["code"],
    },
  ],
