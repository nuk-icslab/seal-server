...
class Controller {
  ...
  static collectRequestParams(request) {
    ...
    request.openapi.schema.parameters.forEach((param) => {
      let camelCaseName = camelCase(param.name);
      if (param.in === "path") {
        requestParams[camelCaseName] = request.openapi.pathParams[param.name];
      } else if (param.in === "query") {
        requestParams[camelCaseName] = request.query[param.name];
      } else if (param.in === "header") {
        requestParams[camelCaseName] = request.headers[param.name];
      }
    });
